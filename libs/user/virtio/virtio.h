...
/** @ingroup user_virtio
 * @struct virtq_desc
 * @brief ディスクリプタ (2.7.5 The Virtqueue Descriptor Table).
// https://docs.oasis-open.org/virtio/virtio/v1.2/csd01/virtio-v1.2-csd01.html#x1-430005
 */
struct virtq_desc {
...
/** @ingroup user_virtio
 * @struct virtq_avail
 * @brief availableリング (2.7.6 The Virtqueue Available Ring).
 ...
 * @brief usedリングの各エントリ (2.7.8 The Virtqueue Used Ring).
...
/** @ingroup user_virtio
 * @struct virtq_used
 * @brief usedリング (2.7.8 The Virtqueue Used Ring).
 * https://docs.oasis-open.org/virtio/virtio/v1.2/csd01/virtio-v1.2-csd01.html#x1-540008
 */
struct virtq_used {
    uint16_t flags;                 /**< フラグ */
 ...
 * @brief ディスクリプタチェーン. このvirtioライブラリで使われる構造体で
 * デバイスドライバはこの構造体を通してデバイスへの処理要求・処理結果を扱う。
 */
struct virtio_chain_entry {
